		...
		scenes: {
			...
			'a2': {
				text:[
					...
					_('lights flash through the alleys between installed.')
				],
				buttons: {
					'continue': {
						text: _('continue'),
			...
			'b4': {
				notification: _('the soldier steps out from between the installed, rifle raised.'),
				combat: true,
				enemy: 'soldier',
				ranged: true,
				chara: 'D',
